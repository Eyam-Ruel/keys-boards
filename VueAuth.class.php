    ...
    public function afficherInscription($error = null) {
            ...
            <div class=\"auth-box\" style=\"max-width: 600px;\">
                ...
                <form action=\"index.php?action=doRegister\" method=\"post\" enctype=\"multipart/form-data\" class=\"auth-form\">
                    ...
                    <div class=\"input-group\">
                        ...
                        <textarea name=\"bio\" rows=\"3\" placeholder=\"Share your musical journey...\"></textarea>
                    </div>

                    <div class=\"input-group\" style=\"position: relative;\">
                        <label>" . ($trad["label_location"] ?? "Location") . "</label>
                        <div style=\"position: relative;\">
                            <input type=\"text\" id=\"city_input\" name=\"city\" placeholder=\"Search your city (ex: Paris, France)...\" autocomplete=\"off\" style=\"width: 100%;\">
                   ...
                   <div class=\"input-group\" style=\"position: relative;\">
                        ...
                        <div style=\"position: relative;\">
                            <input type=\"text\" id=\"lang_input\" placeholder=\"Start typing a language (ex: French, English)...\" autocomplete=\"off\" style=\"width: 100%;\">
                    ...
                    <div class=\"checkbox-group\">
                        ...
                        <label for=\"terms\">
                            I accept the <a href=\"#\" onclick=\"document.getElementById('terms-popup').style.display='block'; return false;\" style=\"color: var(--main-burgundy); text-decoration: underline;\">terms and conditions</a> 
                            and the <a href=\"#\" onclick=\"document.getElementById('privacy-popup').style.display='block'; return false;\" style=\"color: var(--main-burgundy); text-decoration: underline;\">privacy policy</a>.
                        </label>
                    </div>
                ...
                <p class=\"auth-switch\">Already have an account? <a href=\"index.php?action=connexion\">" . ($trad["nav_signin"] ?? "Sign in") . "</a></p>
            </div>
        </div>
        ...
        <div id=\"terms-popup\" style=\"display: none; position: fixed; z-index: 9999; left: 0; top: 0; width: 100%; height: 100%; background: rgba(0,0,0,0.6);\">
            <div style=\"background: white; margin: 10% auto; padding: 30px; border-radius: 16px; width: 80%; max-width: 500px;\">
                ...
                <p>Vos règles d'utilisation LinkUp ici...</p>
                <button onclick=\"document.getElementById('terms-popup').style.display='none'\" class=\"auth-btn\">Close</button>
            </div>
        </div>
        ...
        <div id=\"privacy-popup\" style=\"display: none; position: fixed; z-index: 9999; left: 0; top: 0; width: 100%; height: 100%; background: rgba(0,0,0,0.6);\">
            <div style=\"background: white; margin: 10% auto; padding: 30px; border-radius: 16px; width: 80%; max-width: 500px;\">
                ...
                <p>Infos sur le traitement de vos données de localisation...</p>
                <button onclick=\"document.getElementById('privacy-popup').style.display='none'\" class=\"auth-btn\">Close</button>
            </div>
        </div>
        ";
        echo $this->getPied();
