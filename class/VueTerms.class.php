...
class VueTerms {
    ...
    public function afficher() {
        ...
        <head>
            ...
            <title><?= $trad['terms_title'] ?? 'Terms of Service - Keys & Boards' ?></title>
        ...
        <body>
                    ...
                    <div class="topbar-icons">
                        <div class="lang-dropdown-container">
                            ...
                            <div class="lang-menu" id="langMenu">
                                <a href="?action=terms&lang=en" class="lang-option">🇬🇧 English</a>
                                <a href="?action=terms&lang=fr" class="lang-option">🇫🇷 Français</a>
                                <a href="?action=terms&lang=sq" class="lang-option">🇦🇱 Shqip</a>
                                <a href="?action=terms&lang=vi" class="lang-option">🇻🇳 Tiếng Việt</a>
                            </div>
                        </div>
                    </div>
            ...
            <header class="legal--header">
                <div class="legal--header-content">
                    ...
                    <h1><?= $trad['terms_title'] ?? 'Terms of Service' ?></h1>
                    <p>User agreement and conditions of use for Keys & Boards</p>
                </div>
            </header>

            <main class="legal--main">
                <div class="legal-container">
                    <h1 class="legal-main-title"><?= $trad['terms_main_h1'] ?? '2. User Agreement and Terms of Service (CGU)' ?></h1>

                    <h2 class="legal-section-title"><?= $trad['terms_s1_title'] ?? '2.1. Acceptance of Terms' ?></h2>
                    <div class="legal-block">
                        <?= $trad['terms_s1_text'] ?? 'Before subscribing to the platform, the users must tick a box whereby they accept the terms of service. Accessing and using the Site implies tacit and unreserved acceptance of these conditions.' ?>
                    </div>

                    <h2 class="legal-section-title"><?= $trad['terms_s2_title'] ?? '2.2. Site Access and Maintenance' ?></h2>
                    <div class="legal-block">
                        <?= $trad['terms_s2_text'] ?? 'The Site is accessible free of charge to any User with internet access. All costs related to accessing the Site (hardware, software, internet connection) are exclusively the User\'s responsibility. The Publisher reserves the right to interrupt, temporarily suspend, or modify access to all or part of the Site for maintenance purposes without any obligation or compensation.' ?>
                    </div>

                    <h2 class="legal-section-title"><?= $trad['terms_s3_title'] ?? '2.3. User Account and Security' ?></h2>
                    <div class="legal-block">
                        <?= $trad['terms_s3_text'] ?? 'When creating an account on the Keys & Boards platform, the User agrees to provide accurate and up-to-date information. The User is solely responsible for maintaining the confidentiality of their login credentials and for any activity that occurs under their account.' ?>
                    </div>

                    <h2 class="legal-section-title"><?= $trad['terms_s4_title'] ?? '2.4. User Obligations & Code of Conduct' ?></h2>
                    <div class="legal-block">
                        <?= $trad['terms_s4_text'] ?? 'Users are reminded that the discussions and contents they share must comply to their country’s regulations. Furthermore, Keys & Boards enforces strict good practice rules: users must not use the platform for calling for hate or murder, nor for expressing racist or sexist views.' ?>
                    </div>

                    <h2 class="legal-section-title"><?= $trad['terms_s5_title'] ?? '2.5. Publisher\'s Liability & Information Accuracy' ?></h2>
                    <div class="legal-block">
                        <?= $trad['terms_s5_text'] ?? 'The information and documents on the Site are considered reliable but may contain technical inaccuracies or typographical errors. The Publisher reserves the right to correct them. The Publisher uses all reasonable means to ensure quality access to the Site but cannot be held responsible for network or server malfunctions. Online meetings taking place via 3rd-party operators are subject to the terms of those respective operators.' ?>
                    </div>

                    <h2 class="legal-section-title"><?= $trad['terms_s6_title'] ?? '2.6. Hyperlinks' ?></h2>
                    <div class="legal-block">
                        <?= $trad['terms_s6_text'] ?? 'The Site may contain hypertext links to other websites on the Internet. Because the Publisher has no control over these external sites, we decline all responsibility regarding their content, advertising, products, or services.' ?>
                    </div>

                    <h2 class="legal-section-title"><?= $trad['terms_s7_title'] ?? '2.7. Modification of Terms' ?></h2>
                    <div class="legal-block">
                        <?= $trad['terms_s7_text'] ?? 'The Publisher reserves the right to modify these Terms of Service at any time without prior notice to adapt to the evolution of the Site. Users are advised to regularly consult the latest version available on the Site.' ?>
                    </div>

                    <h2 class="legal-section-title"><?= $trad['terms_s8_title'] ?? '2.8. Applicable Law and Jurisdiction' ?></h2>
                    <div class="legal-block">
                        <?= $trad['terms_s8_text'] ?? 'Both the Keys & Boards platform and its terms of use are governed by French law. In the event of an unresolved dispute regarding the use of the platform, the competent French courts shall have exclusive jurisdiction.' ?>
                    </div>
                </div>
            </main>
