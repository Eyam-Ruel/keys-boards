...
class VueAgenda extends VueBase {
    ...
    private function getEvents() {
        ...
        $sql = "SELECT DISTINCT e.* FROM events e
                ...
                WHERE 
                    e.visibility = 'public' -- Tout le monde voit le public
                    OR e.creator_id = :myId   -- Le créateur voit toujours son événement
                    OR (e.visibility = 'shared' AND ep.user_id = :myId) -- Les participants voient le partagé
