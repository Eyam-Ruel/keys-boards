...
class VueLegal {
    ...
    public function afficher() {
        ...
        <head>
            ...
            <title><?= $trad['legal_info_title'] ?? 'Legal Information - Keys & Boards' ?></title>
            ...
            <style>
                ...
                .logo svg {
                    height: 35px; /* Hauteur parfaite pour la barre de navigation */
                    width: auto;
                }
        ...
        <body>
                    ...
                    <div class="topbar-icons">
                        <div class="lang-dropdown-container">
                            ...
                            <div class="lang-menu" id="langMenu">
                                <a href="?action=legal&lang=en" class="lang-option">🇬🇧 English</a>
                                <a href="?action=legal&lang=fr" class="lang-option">🇫🇷 Français</a>
                                <a href="?action=legal&lang=sq" class="lang-option">🇦🇱 Shqip</a>
                                <a href="?action=legal&lang=vi" class="lang-option">🇻🇳 Tiếng Việt</a>
                            </div>
                        </div>
                    </div>
            ...
            <header class="legal--header">
                <div class="legal--header-content">
                    ...
                    <h1><?= $trad['legal_info_title'] ?? 'Legal Information' ?></h1>
                    <p>Official and regulatory details of Keys & Boards</p>
                </div>
            </header>

            <main class="legal--main">
                <div class="legal-container">
                    <h1 class="legal-main-title"><?= $trad['legal_main_h1'] ?? '1. Legal Information' ?></h1>
                    
                    <div class="legal-block">
                        <?= $trad['legal_intro'] ?? 'In accordance with Article 6 of the French Law No. 2004-575 of June 21, 2004, for confidence in the digital economy, the identity of the various parties involved in the creation and monitoring of the website is specified below:' ?>
                    </div>

                    <h2 class="legal-section-title"><?= $trad['legal_s1_title'] ?? '1.1. Site Publisher & Company Status' ?></h2>
                    <div class="legal-block">
                        The website Keys & Boards is published by:<br><br>
                        <strong><?= $trad['legal_s1_name'] ?? 'Company Name:' ?></strong> <?= $trad['legal_s1_name_val'] ?? 'Keys & Boards (Simulated small company strictly for academic purposes).' ?><br>
                        <strong><?= $trad['legal_s1_partners'] ?? 'Institutional Partners:' ?></strong> <?= $trad['legal_s1_partners_val'] ?? 'IUT de Bobigny, Université Sorbonne Paris-Nord, USPN (France); University of Tirana, UT (Albania); Hanoi University of Science, VNU (Vietnam).' ?><br>
                        <strong><?= $trad['legal_s1_address'] ?? 'Address:' ?></strong> 1 Rue de Chablis, 93000 Bobigny, France.<br>
                        <strong><?= $trad['legal_s1_phone'] ?? 'Phone:' ?></strong> 07 67 24 28 21.
                    </div>

                    <h2 class="legal-section-title"><?= $trad['legal_s2_title'] ?? '1.2. Director of Publication' ?></h2>
                    <div class="legal-block">
                        <strong><?= $trad['legal_s2_dir'] ?? 'Director of Publication:' ?></strong> <?= $trad['legal_s2_dir_val'] ?? 'Azad Oztopal (acting on behalf of the Keys & Boards team).' ?><br>
                        <strong><?= $trad['legal_s2_contact'] ?? 'Contact:' ?></strong> azad.oztopal.pro@gmail.com / 07 67 24 28 21.
                    </div>

                    <h2 class="legal-section-title"><?= $trad['legal_s3_title'] ?? '1.3. Hosting' ?></h2>
                    <div class="legal-block">
                        <strong><?= $trad['legal_s3_host'] ?? 'Host:' ?></strong> IUT de Bobigny.<br>
                        <strong><?= $trad['legal_s1_address'] ?? 'Address:' ?></strong> 1 Rue de Chablis, 93000 Bobigny, France.<br>
                        <strong><?= $trad['legal_s3_server'] ?? 'Server Type:' ?></strong> LAMP server.<br>
                        <strong><?= $trad['legal_s3_url'] ?? 'URL:' ?></strong> The site will be visible under the hierarchy of the host http://international.iut-bobigny.univ-paris13.fr.
                    </div>

                    <h2 class="legal-section-title"><?= $trad['legal_s4_title'] ?? '1.4. Intellectual Property' ?></h2>
                    <div class="legal-block">
                        <?= $trad['legal_s4_text'] ?? 'The Keys & Boards team owns the intellectual property rights and holds the rights of use on all the elements accessible on the website, in particular the texts, images, graphics, logos, videos, and icons. Any reproduction, representation, modification, publication, or adaptation of all or part of the elements of the site is prohibited without prior written consent.' ?>
                    </div>
                </div>
            </main>
