...
class VueAuth {
    ...
    public function afficherConnexion($error = null) {
        global $trad;
        echo $this->getEntete($trad['signin_box_title'] ?? "Sign In - LinkUp");
        
        // --- LOGO SVG COMPOSITE (ICÔNE + TEXTE) ---
        $logoSvg = '
        ...
        <div class="auth-container">
            <div class="auth-box">
                <a href="index.php" class="back-home">< ' . ($trad['side_home'] ?? 'Back to home') . '</a>
                ' . $logoSvg . '
                <p class="auth-subtitle">' . ($trad['signin_box_title'] ?? 'Sign in to your account') . '</p>
                ...
                <form action="index.php?action=doConnect" method="post" class="auth-form">
                    <div class="input-group">
                        <label>' . ($trad['label_email'] ?? 'Email') . '</label>
                        <input type="email" name="email" placeholder="yourname@example.com" required>
                    </div>
                    <div class="input-group">
                        <label>' . ($trad['label_password'] ?? 'Password') . '</label>
                        <input type="password" name="pass" placeholder="••••••••" required>
                    </div>
                    <button type="submit" class="auth-btn">' . ($trad['btn_submit_signin'] ?? 'Sign In') . '</button>
                </form>

                <div class="divider" style="text-align:center; margin: 20px 0; color: #666;">
                    <span>' . ($trad['or_continue_with'] ?? 'or continue with') . '</span>
                </div>

                <div id="google-signin-btn" style="display:flex; justify-content:center;">
                    <button type="button" class="btn-google" onclick="handleGoogleSignIn()" style="display:flex; align-items:center; gap:10px; padding:10px 20px; border:1px solid #ddd; border-radius:8px; background:white; cursor:pointer; font-family:\'DM Sans\';">
                        ...
                        ' . ($trad['btn_google_signin'] ?? 'Sign in with Google') . '
                    </button>
                </div>
                <p class="auth-switch">' . ($trad['signin_no_account'] ?? 'Don\'t have an account?') . ' <a href="index.php?action=inscription">' . ($trad['link_create_account'] ?? 'Create account') . '</a></p>
            </div>
        </div>';
        echo $this->getPied();
    }
    ...
    public function afficherInscription($error = null) {
        global $trad;
        echo $this->getEntete($trad['nav_signup'] ?? "Join LinkUp");
            ...
            <svg viewBox="0 0 1292 535" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" xml:space="preserve" xmlns:serif="http://www.serif.com/" style="fill-rule:evenodd;clip-rule:evenodd;stroke-linejoin:round;stroke-miterlimit:2;">
                <g>
                    <g>
                        <path d="M1143.69,472.972c-10.294,14.52 -31.912,37.655 -75.554,52.932c-51.105,17.889 -150.174,15.677 -171.765,-73.212c-0.443,-1.824 -6.251,-25.05 -3.245,-49.464c6.919,-56.189 53.54,-115.016 88.353,-162.104c-6.129,-20.894 -17.819,-76.625 -17.447,-124.657c0.187,-24.084 2.442,-99.297 63.055,-114.083c21.402,-5.221 35.298,-0.385 38.184,0.619c16.165,5.625 23.689,16.507 24.866,18.06c18,23.751 18.943,60.155 9.149,89.024c-12.708,37.459 -49.486,99.77 -92.854,156.606c4.878,10.999 10.691,22.617 17.279,34.511c3.543,-1.738 7.377,-3.407 11.559,-5.08c13.289,-5.316 21.145,-6.215 24.692,-6.704c72.707,-10.025 113.596,51.681 111.24,93.65c-0.462,8.237 -2.22,40.665 -16.451
                        <path d="M336.468,376.819c-35.818,0 -73.923,39.74 -73.923,82.537c0,26.366 14.48,40.504 42.296,40.504c36.961,0 73.161,-39.358 73.161,-81.391c0,-27.13 -14.861,-41.651 -41.534,-41.651Zm-32.389,117.31c-6.478,0 -9.145,-6.114 -9.145,-19.106c0,-39.358 24.006,-92.09 41.915,-92.09c6.097,0 8.764,5.732 8.764,19.87c0,40.504 -22.863,91.326 -41.534,91.326Z" style="fill:#810F29;fill-rule:nonzero;"/>
        ...
        <div class=\"auth-container\">
            <div class=\"auth-box\" style=\"max-width: 600px;\">
                ...
                <p class=\"auth-subtitle\">" . ($trad["hero_subtitle"] ?? "Join the intergenerational music community") . "</p>
                
                <form action=\"index.php?action=doRegister\" method=\"post\" enctype=\"multipart/form-data\" class=\"auth-form\">
                    
                    <h3 class=\"form-section-title\">" . ($trad["signup_section_credentials"] ?? "Credentials") . "</h3>
                    <div class=\"input-group\">
                        <label>" . ($trad["label_email"] ?? "Email") . "</label>
                        <input type=\"email\" name=\"email\" placeholder=\"yourname@example.com\" required>
                    </div>
                    ...
                    <div style=\"display: flex; gap: 15px;\">
                        <div class=\"input-group\" style=\"flex: 1;\">
                            <label>" . ($trad["label_display_name"] ?? "Display name") . "</label>
                            <input type=\"text\" name=\"display_name\" placeholder=\"" . ($trad['placeholder_name'] ?? 'e.g., Jean Dupont') . "\" required>
                        </div>
                        <div class=\"input-group\" style=\"flex: 1;\">
                            <label>" . ($trad["label_handle"] ?? "Handle") . "</label>
                            <input type=\"text\" name=\"pseudo\" placeholder=\"e.g., jeandupont\" required>
                        </div>
                    </div>

                    <h3 class=\"form-section-title\">" . ($trad["signup_section_profile"] ?? "Profile & Bio") . "</h3>
                    <div class=\"input-group\">
                        <label>" . ($trad["label_bio"] ?? "Tell us about yourself") . "</label>
                        <textarea name=\"bio\" rows=\"3\" placeholder=\"" . ($trad['placeholder_bio'] ?? 'Share your musical journey...') . "\"></textarea>
                    </div>

                    <div class=\"input-group\" style=\"position: relative;\">
                        <label>" . ($trad["label_location"] ?? "Location") . "</label>
                        <div style=\"position: relative;\">
                            <input type=\"text\" id=\"city_input\" name=\"city\" placeholder=\"" . ($trad['placeholder_city'] ?? 'Search your city...') . "\" autocomplete=\"off\" style=\"width: 100%;\">
                        ...
                        <input type=\"hidden\" id=\"country_input\" name=\"country\">
                    </div>

                   <div class=\"input-group\" style=\"position: relative;\">
                        <label>" . ($trad['label_languages'] ?? 'Languages spoken') . "</label>
                        <div style=\"position: relative;\">
                            <input type=\"text\" id=\"lang_input\" placeholder=\"" . ($trad['placeholder_add_lang'] ?? 'Start typing a language...') . "\" autocomplete=\"off\" style=\"width: 100%;\">
                            <div id=\"lang_suggestions\" class=\"suggestions-list\"></div>
                        </div>
                        <div id=\"selected_langs_container\" style=\"display: flex; gap: 8px; flex-wrap: wrap; margin-top: 10px;\"></div>
                        <input type=\"hidden\" name=\"languages\" id=\"final_langs_input\">
                    </div>

                    <div class=\"checkbox-group\" style=\"margin-top: 5px; margin-bottom: 20px;\">
                        <input type=\"checkbox\" name=\"share_location\" id=\"share_location\" value=\"1\" checked>
                        <label for=\"share_location\" style=\"font-size: 12px; color: #666;\">
                            " . ($trad["label_share_loc"] ?? "J'accepte que ma localisation soit partagée sur la carte") . "
                        </label>
                    </div>

                    <h3 class=\"form-section-title\">" . ($trad["signup_section_appearance"] ?? "Appearance") . "</h3>
                    <div class=\"input-group\">
                        <label>" . ($trad["label_profile_photo"] ?? "Profile photo") . "</label>
                    ...
                    <div class=\"checkbox-group\">
                        ...
                        <label for=\"terms\">
                            " . ($trad['label_accept_terms'] ?? 'I accept the') . " <a href=\"#\" onclick=\"document.getElementById('terms-popup').style.display='block'; return false;\" style=\"color: var(--main-burgundy); text-decoration: underline;\">" . ($trad['link_terms'] ?? 'terms and conditions') . "</a> 
                            " . ($trad['label_and_the'] ?? 'and the') . " <a href=\"#\" onclick=\"document.getElementById('privacy-popup').style.display='block'; return false;\" style=\"color: var(--main-burgundy); text-decoration: underline;\">" . ($trad['link_privacy'] ?? 'privacy policy') . "</a>.
                        </label>
                    </div>
                    
                    <button type=\"submit\" class=\"auth-btn\">" . ($trad["btn_create_profile"] ?? "Create my profile") . "</button>
                </form>
                
                <p class=\"auth-switch\">" . ($trad['signup_already_account'] ?? 'Already have an account?') . " <a href=\"index.php?action=connexion\">" . ($trad["nav_signin"] ?? "Sign in") . "</a></p>
            </div>
        </div>

        <div id=\"terms-popup\" style=\"display: none; position: fixed; z-index: 9999; left: 0; top: 0; width: 100%; height: 100%; background: rgba(0,0,0,0.6);\">
            <div style=\"background: white; margin: 10% auto; padding: 30px; border-radius: 16px; width: 80%; max-width: 500px;\">
                <h2>" . ($trad['link_terms'] ?? 'Terms & Conditions') . "</h2>
                <p>" . ($trad['terms_content'] ?? 'Rules here...') . "</p>
                <button onclick=\"document.getElementById('terms-popup').style.display='none'\" class=\"auth-btn\">" . ($trad['btn_close'] ?? 'Close') . "</button>
            </div>
        </div>

        <div id=\"privacy-popup\" style=\"display: none; position: fixed; z-index: 9999; left: 0; top: 0; width: 100%; height: 100%; background: rgba(0,0,0,0.6);\">
            <div style=\"background: white; margin: 10% auto; padding: 30px; border-radius: 16px; width: 80%; max-width: 500px;\">
                <h2>" . ($trad['link_privacy'] ?? 'Privacy Policy') . "</h2>
                <p>" . ($trad['privacy_content'] ?? 'Privacy info here...') . "</p>
                <button onclick=\"document.getElementById('privacy-popup').style.display='none'\" class=\"auth-btn\">" . ($trad['btn_close'] ?? 'Close') . "</button>
            </div>
        </div>
        ";
        echo $this->getPied();
    ...
    private function getEntete($titre) {
        global $trad;
        $current_action = isset($_GET['action']) ? $_GET['action'] : 'connexion';
        ...
        <head>
            ...
            <style>
                ...
                .auth-body { 
                    margin: 0; 
                    padding: 0; 
                    background: linear-gradient(180deg, #E7FBFB 0%, #FFFFFF 50%, rgba(170, 233, 238, 0.2) 100%); 
                ...
                .input-group label { display: block; margin-bottom: 5px; font-weight: 500; font-size: 13px; color: var(--text-dark); }
                ...
                .suggestion-item {
                    ...
                    transition: background 0.2s; border-bottom: 1px solid #f8f8f8; color: #333;
                }
                .suggestion-item:hover { background-color: #f1f1f1; color: var(--main-burgundy); }

                .form-section-title {
                    margin: 25px 0 15px 0; font-size: 15px; color: var(--main-burgundy);
                    border-bottom: 1px solid #eee; padding-bottom: 5px;
                }

                .auth-btn {
                    width: 100%; padding: 12px; background-color: var(--main-burgundy);
                ...
                .lang-menu {
                    ...
                    box-shadow: 0px 8px 16px rgba(0,0,0,0.1); border-radius: 8px;
                    z-index: 1001; overflow: hidden; border: 1px solid var(--border-soft);
                }
                .lang-menu.show { display: block; }
                .lang-option {
                    color: var(--text-dark); padding: 10px 16px; text-decoration: none;
                    display: block; font-size: 14px; transition: background 0.2s;
                }
                .lang-option:hover { background-color: var(--border-soft); color: var(--accent); }
                
                .checkbox-group { display: flex; align-items: flex-start; gap: 10px; margin-top: 20px; margin-bottom: 20px; }
                .checkbox-group input { margin-top: 3px; }
                .checkbox-group label { font-size: 12px; color: var(--text-dark); line-height: 1.4; }
                .auth-switch { text-align: center; margin-top: 20px; font-size: 14px; }
                .auth-switch a { color: var(--main-burgundy); font-weight: bold; text-decoration: none; }
                .back-home { color: var(--main-burgundy); text-decoration: none; font-size: 14px; font-weight: 500; display: inline-block; margin-bottom: 20px; }
                .auth-subtitle { text-align: center; color: #666; margin-bottom: 30px; font-size: 15px; }

                .logo-composite { text-align: center; margin-bottom: 20px; }
                .logo-composite svg { height: 50px; width: auto; }
            </style>
        </head>
            ...
            <header class="topbar">
                ...
                <div class="topbar-right">
                    <div class="topbar-icons">
                        <button class="circle-btn" id="themeToggleBtn" title="' . ($trad['side_change_theme'] ?? 'Change theme') . '">
                            <img src="./img/icons/Light Mode.png" alt="Theme" class="topbar-icon-img" id="themeIcon">
                        </button>
                        <div class="lang-dropdown-container">
                            <button class="circle-btn" id="langToggleBtn" title="' . ($trad['side_change_lang'] ?? 'Change language') . '">
            ...
            <script>
                ...
                function handleGoogleSignIn() {
                    const client = google.accounts.oauth2.initTokenClient({
                        client_id: "419699690840-orf303bc63od9bdcq35ddd9iejtfnp19.apps.googleusercontent.com",
                        scope: "email profile",
                        callback: async (response) => {
                            try {
                                ...
                                fetch("index.php?action=doGoogleLogin", {
                                    method: "POST",
                                    body: formData
                                }).then(() => { window.location.href = "index.php"; });
                            } catch (error) { console.error("Erreur Google Auth:", error); }
                        },
                    });
                    client.requestAccessToken();
                }

                // --- GESTION GLOBALE DES LANGUES ---
                ...
                function updateLangDisplay() {
                    const container = document.getElementById("selected_langs_container");
                    const hiddenInput = document.getElementById("final_langs_input");
                    if(!container || !hiddenInput) return;

                    container.innerHTML = "";
                    selectedLanguages.forEach(lang => {
                        const badge = document.createElement("span");
                        badge.style = "background: #810F29; color: white; padding: 5px 12px; border-radius: 20px; font-size: 12px; display: flex; align-items: center; gap: 8px; cursor: default; margin-bottom: 5px;";
                        badge.innerHTML = `${lang} <span style="cursor:pointer; font-weight:bold; padding: 0 4px; font-size: 14px;">×</span>`;
                        badge.querySelector("span").addEventListener("click", () => removeLanguage(lang));
                ...
                document.addEventListener("DOMContentLoaded", function() {
                                    ...
                                    if (data.length > 0) {
                                        ...
                                        data.forEach(item => {
                                            ...
                                            div.onclick = function() {
                                                ...
                                                cityInput.value = cityName ? `${cityName}, ${addr.country}` : item.display_name;
                                                document.getElementById("lat_input").value = item.lat;
                                                document.getElementById("lng_input").value = item.lon;
                                                document.getElementById("country_input").value = addr.country;
                    ...
                    // --- Autocomplétion Langues (Massive & Native) ---
                    const langInput = document.getElementById("lang_input");
                    const langSuggestions = document.getElementById("lang_suggestions");
                    
                    // Liste étendue avec noms locaux (Autonymes)
                    const languagesData = {
                        "French": "Français", "English": "English", "Albanian": "Shqip", "Vietnamese": "Tiếng Việt",
                        "Spanish": "Español", "German": "Deutsch", "Italian": "Italiano", "Portuguese": "Português",
                        "Arabic": "العربية", "Chinese": "中文", "Japanese": "日本語", "Russian": "Русский",
                        "Korean": "한국어", "Hindi": "हिन्दी", "Turkish": "Türkçe", "Dutch": "Nederlands",
                        "Greek": "Ελληνικά", "Polish": "Polski", "Swedish": "Svenska", "Danish": "Dansk",
                        "Finnish": "Suomi", "Norwegian": "Norsk", "Thai": "ไทย", "Indonesian": "Bahasa Indonesia",
                        "Romanian": "Română", "Hungarian": "Magyar", "Czech": "Čeština", "Persian": "فارسی",
                        "Hebrew": "עברית", "Bengali": "বাংলা", "Punjabi": "ਪੰਜਾਬੀ", "Ukrainian": "Українська"
                    };
                    ...
                    if (langInput) {
                        langInput.addEventListener("input", function() {
                            ...
                            if (query.length < 1) { langSuggestions.style.display = "none"; return; }
                            ...
                            for (const [eng, local] of Object.entries(languagesData)) {
                                if (eng.toLowerCase().includes(query) || local.toLowerCase().includes(query)) {
                                    ...
                                    langSuggestions.appendChild(div);
                                }
                            }
                            langSuggestions.style.display = found ? "block" : "none";
                        });
                    }
                    ...
                    document.addEventListener("click", function(event) {
                        if (langMenu && !langToggleBtn.contains(event.target)) langMenu.classList.remove("show");
                        if (citySuggestions && event.target !== cityInput) citySuggestions.style.display = "none";
                        if (langSuggestions && event.target !== langInput) langSuggestions.style.display = "none";
                    });
