...
class VueFAQ {
    public function afficher() {
        ...
        <head>
            ...
            <title><?= $trad['faq_title'] ?? 'FAQ - Keys & Boards' ?></title>
            ...
            <style>
                ...
                /* BANNIÈRE FAQ */
                .faq--header { background-color: rgb(var(--darkred)); color: white; padding: 120px 20px 60px; text-align: center; }
                .faq--header-content { max-width: 900px; margin: 0 auto; }
                .faq--back-link { color: white; text-decoration: none; font-size: 14px; display: flex; align-items: center; justify-content: center; gap: 8px; margin-bottom: 25px; opacity: 0.9; }
                .faq--header h1 { font-family: "Jost", sans-serif; font-size: 36px; margin: 0 0 10px 0; }
                .faq--header p { font-size: 18px; opacity: 0.9; margin: 0; }

                /* CONTENU */
                .faq--main { display: flex; justify-content: center; padding: 40px 20px 80px 20px; }
                .faq--container { background-color: white; width: 100%; max-width: 900px; border-radius: 12px; padding: 50px; box-shadow: 0 4px 20px rgba(0,0,0,0.03); }
                
                .faq--section { margin-bottom: 50px; }
                .faq--section-title { color: rgb(var(--darkred)); font-size: 24px; font-weight: 700; margin-bottom: 25px; border-bottom: 1px solid rgba(129,15,41, 0.1); padding-bottom: 10px; }
                .faq--item { margin-bottom: 25px; }
                .faq--question { font-size: 18px; font-weight: 700; color: #111; margin-bottom: 12px; }
                .faq--answer { background-color: #F8F9FA; padding: 20px; border-radius: 8px; font-size: 15px; line-height: 1.6; color: #444; }
                .faq--answer p { margin: 0; }

                .faq--contact-box { margin-top: 60px; border-top: 2px solid #F0F0F0; padding-top: 40px; }
                .faq--contact-email { background-color: #F8F9FA; padding: 20px; border-radius: 8px; font-size: 16px; margin-top: 15px; }
                .faq--contact-email a { color: #4A90E2; text-decoration: none; font-weight: 500; }
        ...
        <body>
            ...
            <header class="faq--header">
                <div class="faq--header-content">
                    <a href="index.php" class="faq--back-link">
                        <svg viewBox="0 0 24 24" width="16" height="16" fill="currentColor"><path d="M20 11H7.83l5.59-5.59L12 4l-8 8 8 8 1.41-1.41L7.83 13H20v-2z"/></svg>
                        <?= $trad['side_home'] ?? 'Back to Home' ?>
                    </a>
                    <h1><?= $trad['faq_header_h1'] ?? 'Frequently Asked Questions' ?></h1>
                    <p><?= $trad['faq_header_p'] ?? 'Everything you need to know about Keys & Boards' ?></p>
                </div>
            </header>
            ...
            <main class="faq--main">
                <div class="faq--container">
                    <section class="faq--section">
                        <h2 class="faq--section-title"><?= $trad['faq_sec1_title'] ?? 'Getting Started' ?></h2>
                        <div class="faq--item">
                            <h3 class="faq--question"><?= $trad['faq_q1_1'] ?? 'What is Keys & Boards?' ?></h3>
                            <div class="faq--answer"><p><?= $trad['faq_a1_1'] ?? 'Keys & Boards is an intergenerational platform that connects music lovers of all ages...' ?></p></div>
                        </div>
                        <div class="faq--item">
                            <h3 class="faq--question"><?= $trad['faq_q1_2'] ?? 'How do I create an account?' ?></h3>
                            <div class="faq--answer"><p><?= $trad['faq_a1_2'] ?? 'Click on the "Join Now" button on the homepage...' ?></p></div>
                        </div>
                        <div class="faq--item">
                            <h3 class="faq--question"><?= $trad['faq_q1_3'] ?? 'Is Keys & Boards free to use?' ?></h3>
                            <div class="faq--answer"><p><?= $trad['faq_a1_3'] ?? 'Yes, Keys & Boards is completely free to use.' ?></p></div>
                        </div>
                    </section>

                    <section class="faq--section">
                        <h2 class="faq--section-title"><?= $trad['faq_sec2_title'] ?? 'Using the Platform' ?></h2>
                        <div class="faq--item">
                            <h3 class="faq--question"><?= $trad['faq_q2_1'] ?? 'What are Music Boards?' ?></h3>
                            <div class="faq--answer"><p><?= $trad['faq_a2_1'] ?? 'Music Boards are community spaces organized by genre or topic...' ?></p></div>
                        </div>
                        <div class="faq--item">
                            <h3 class="faq--question"><?= $trad['faq_q2_2'] ?? 'How do I connect with other members?' ?></h3>
                            <div class="faq--answer"><p><?= $trad['faq_a2_2'] ?? 'You can explore members through the Explore page...' ?></p></div>
                        </div>
                        <div class="faq--item">
                            <h3 class="faq--question"><?= $trad['faq_q2_3'] ?? 'Can I share audio and video content?' ?></h3>
                            <div class="faq--answer"><p><?= $trad['faq_a2_3'] ?? 'Yes! You can share audio recordings, video clips, and images...' ?></p></div>
                        </div>
                        <div class="faq--item">
                            <h3 class="faq--question"><?= $trad['faq_q2_4'] ?? 'What is the Calendar feature?' ?></h3>
                            <div class="faq--answer"><p><?= $trad['faq_a2_4'] ?? 'The Calendar feature allows you to schedule and manage music sessions...' ?></p></div>
                        </div>
                    </section>

                    <section class="faq--section">
                        <h2 class="faq--section-title"><?= $trad['faq_sec3_title'] ?? 'Privacy & Safety' ?></h2>
                        <div class="faq--item">
                            <h3 class="faq--question"><?= $trad['faq_q3_1'] ?? 'Is my personal information safe?' ?></h3>
                            <div class="faq--answer"><p><?= $trad['faq_a3_1'] ?? 'Yes. We comply with GDPR regulations and take your privacy seriously.' ?></p></div>
                        </div>
                        <div class="faq--item">
                            <h3 class="faq--question"><?= $trad['faq_q3_2'] ?? 'What if I encounter inappropriate behavior?' ?></h3>
                            <div class="faq--answer"><p><?= $trad['faq_a3_2'] ?? 'We have a strict code of conduct...' ?></p></div>
                        </div>
                        <div class="faq--item">
                            <h3 class="faq--question"><?= $trad['faq_q3_3'] ?? 'Can I delete my account?' ?></h3>
                            <div class="faq--answer"><p><?= $trad['faq_a3_3'] ?? 'Yes. You have the right to delete your account...' ?></p></div>
                        </div>
                    </section>

                    <section class="faq--section">
                        <h2 class="faq--section-title"><?= $trad['faq_sec4_title'] ?? 'Technical Support' ?></h2>
                        <div class="faq--item">
                            <h3 class="faq--question"><?= $trad['faq_q4_1'] ?? 'Which browsers are supported?' ?></h3>
                            <div class="faq--answer"><p><?= $trad['faq_a4_1'] ?? 'Keys & Boards works best on modern browsers including Google Chrome...' ?></p></div>
                        </div>
                        <div class="faq--item">
                            <h3 class="faq--question"><?= $trad['faq_q4_2'] ?? 'Is there a mobile app?' ?></h3>
                            <div class="faq--answer"><p><?= $trad['faq_a4_2'] ?? 'Currently, Keys & Boards is a web-based platform optimized for both desktop and mobile browsers.' ?></p></div>
                        </div>
                        <div class="faq--item">
                            <h3 class="faq--question"><?= $trad['faq_q4_3'] ?? 'I\'m having technical issues. Who can I contact?' ?></h3>
                            <div class="faq--answer"><p><?= $trad['faq_a4_3'] ?? 'For technical support, please contact us at azad.oztopal.pro@gmail.com...' ?></p></div>
                        </div>
                    </section>

                    <div class="faq--contact-box">
                        <h2 class="faq--section-title"><?= $trad['faq_contact_title'] ?? 'Still have questions?' ?></h2>
                        <p><?= $trad['faq_contact_text'] ?? 'If you couldn\'t find the answer you were looking for, please don\'t hesitate to reach out to us.' ?></p>
                        <div class="faq--contact-email">
                            <strong><?= $trad['faq_contact_us'] ?? 'Contact us:' ?></strong> <a href="mailto:azad.oztopal.pro@gmail.com">azad.oztopal.pro@gmail.com</a>
                        </div>
                    </div>
                </div>
            </main>
