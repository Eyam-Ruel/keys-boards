...
class VueHome {
    public function afficher() {
        // On récupère le dictionnaire global
        global $trad;
        ?>
        <!DOCTYPE html>
        <html lang="en">
        <head>
            ...
            <style>
                ...
                .cta--button {
                    ...
                    box-shadow: 0 4px 15px rgba(102, 127, 230, 0.3);
                }
    ...
    <img src="img/icons/Language.png" alt="Language icon" class="topbar-icon-img">
            ...
            <main class="public--main--wrapper">
                <section class="public--firstSection">
                    <div class="public--firstSection--content">
                        <h1><?= $trad['hero_title'] ?? 'Keys & Boards' ?></h1>
                        <p class="intro--text">
                            <?= $trad['hero_subtitle'] ?? 'Join the first global music community where generations come together. Share your sounds, pass on your talent, and learn from the best.' ?>
                        </p>
                        <input type="button" value="<?= $trad['btn_join_now'] ?? 'Join Now' ?>" class="join--button red--button" onclick="window.location.href='index.php?action=inscription'">
                    </div>
                </section>
                ...
                <section class="public--whySection">
                    <div class="public--whySection--content">
                        <h2><?= $trad['why_title'] ?? 'Why Keys & Boards' ?></h2>
                        <p class="public--text"><?= $trad['why_subtitle'] ?? 'Connect with musicians across generations, share your passion, and learn together' ?></p>
                        <div class="goals--container">
                            <div class="goal">
                                <img src="img/partnersIcon.png" alt="partnersIcon" class="goal--icon">
                                <strong><?= $trad['feature_1_title'] ?? 'Find Partners' ?></strong>
                                <p class="public--text"><?= $trad['feature_1_desc'] ?? 'Discover music enthusiasts near you who share your interests, from Jazz to MAO' ?></p>
                            </div>
                            <div class="goal">
                                <img src="img/scheduleIcon.png" alt="scheduleIcon" class="goal--icon">
                                <strong><?= $trad['feature_2_title'] ?? 'Schedule Sessions' ?></strong>
                                <p class="public--text"><?= $trad['feature_2_desc'] ?? 'Organize jam sessions, lessons, and music events with an integrated calendar' ?></p>
                            </div>
                            <div class="goal">
                                <img src="img/chatIcon.png" alt="chatIcon" class="goal--icon">
                                <strong><?= $trad['feature_3_title'] ?? 'Chat Securely' ?></strong>
                                <p class="public--text"><?= $trad['feature_3_desc'] ?? 'Connect through our secure messaging system and share your musical journey' ?></p>
                            </div>
                        </div>
                    </div>
                </section>

                <section class="public--whoSection">
                    <div class="public--whoSection--content">
                        ...
                        <div class="ages--container">
                            <div class="age genZ white">
                                ...
                                <strong><?= $trad['target_genz_title'] ?? 'Gen Z & Millenials' ?></strong>
                                <p class="public--text white"><?= $trad['target_genz_desc'] ?? 'Discover new sounds, share your music production creations, and connect with experienced mentors' ?></p>
                            </div>
                            <div class="age genX white">
                                <span><img src="img/guitar.png" alt="guitarIcon"></span>
                                <strong><?= $trad['target_genx_title'] ?? 'Gen X' ?></strong>
                                <p class="public--text white"><?= $trad['target_genx_desc'] ?? 'Pass on your passion for rock, jazz, or blues and learn new production techniques' ?></p>
                            </div>
                            <div class="age babyBoomers">
                                <span><img src="img/trumpet.png" alt="trumpetIcon"></span>
                                <strong><?= $trad['target_boomers_title'] ?? 'Baby Boomers' ?></strong>
                                <p class="public--text"><?= $trad['target_boomers_desc'] ?? 'Share your musical stories and discover how music evolves with new generations' ?></p>
                            </div>
                            <div class="age seniors">
                                <span><img src="img/keyOfG.png" alt="KeyOfGIcon"></span>
                                <strong><?= $trad['target_seniors_title'] ?? 'Seniors' ?></strong>
                                <p class="public--text"><?= $trad['target_seniors_desc'] ?? 'Stay musically active, teach your expertise, and learn at your own pace with an accessible interface' ?></p>
                            </div>
                        </div>
                    </div>
                </section>

                <section class="public--ctaSection">
                    <div class="public--ctaSection--content">
                        <h2><?= $trad['target_conclusion'] ?? 'No matter your age, your musical story has value!' ?></h2>
                        <button class="cta--button" onclick="window.location.href='index.php?action=inscription'"><?= $trad['btn_join_community'] ?? 'Join the Community' ?></button>
                    </div>
                </section>
            </main>
            ...
            <footer class="site--footer">
                <div class="footer--main_content">
                    <div class="footer--column">
                        <h3 class="footer--brand"><a href="index.php" style="text-decoration: none; color: inherit;">LinkUp</a></h3>
                ...
                <div class="footer--bottom">
                    <p><?= $trad['footer_copyright'] ?? '© 2026 LinkUp. All rights reserved.' ?></p>
                </div>
            </footer>
