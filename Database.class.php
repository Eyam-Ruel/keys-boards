...
class Database {
    ...
    private static $db_name = "linkup";      // Le login sert aussi de nom de base
    private static $username = "linkup";     // Login fourni : linkup
    private static $password = "!*linkup2026"; // Mdp fourni : !*linkup2026
    private static $port = "3306";           // Port standard MySQL
